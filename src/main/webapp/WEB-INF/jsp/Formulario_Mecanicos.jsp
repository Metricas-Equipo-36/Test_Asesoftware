    ...
    <div class="row h-100">
        ...
        <div class="col-sm-3 side-menu pt-5 h-auto">
            ...
            <div class="row d-flex flex-row-reverse">
                <a class="button-menu rounded-0 btn btn-lg" href="/reservation/index"><i
                        class="material-icons md-18 float-left icon">date_range</i>Reservas Mecanicos</a>
            </div>
            <div class="row d-flex flex-row-reverse">
                <button class="button-menu rounded-0 btn btn-lg selected-button"><i
                        class="material-icons md-18 float-left icon">movie</i>Mecanicos
                </button>
            </div>
        </div>
        <!--Content-->
                ...
                <div class="col">
                    <form class="form-inline" method="POST" action="#">
                        <div class="form-group mb-2">
                            ...
                            <input type="date" class="form-control rounded-pill" value="2019-08-17"
                                   onchange="this.form.submit()" id="date">
                        </div>
                    </form>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="mecanic_create">
                    <div class="form-group row">
                        <label for="mec1" class="col-sm-2 col-form-label">Tipo Documento</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="mec1" name="movieTitle" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="mec2" class="col-sm-2 col-form-label">Documento</label>
                        <!--%= f.label :Titulo, class: "nifty_form" ,for: "movieTitle" %-->
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="mec2" name="movieTitle" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="mec3" class="col-sm-2 col-form-label">Primer Nombre</label>
                        <!--%= f.label :Titulo, class: "nifty_form" ,for: "movieTitle" %-->
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="mec3" name="movieTitle" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="mec4" class="col-sm-2 col-form-label">Segundo Nombre</label>
                        <!--%= f.label :Titulo, class: "nifty_form" ,for: "movieTitle" %-->
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="mec4" name="movieTitle" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="mec5" class="col-sm-2 col-form-label">Primer Apellido</label>
                        <!--%= f.label :Titulo, class: "nifty_form" ,for: "movieTitle" %-->
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="mec5" name="movieTitle" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="mec6" class="col-sm-2 col-form-label">Segundo Apellido</label>
                        <!--%= f.label :Titulo, class: "nifty_form" ,for: "movieTitle" %-->
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="mec6" name="movieTitle" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="mec7" class="col-sm-2 col-form-label">Celular</label>
                        <!--%= f.label :Titulo, class: "nifty_form" ,for: "movieTitle" %-->
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="mec7" name="movieTitle" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="mec18" class="col-sm-2 col-form-label">Dirección</label>
                        <!--%= f.label :Titulo, class: "nifty_form" ,for: "movieTitle" %-->
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="mec18" name="movieTitle" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="mec9" class="col-sm-2 col-form-label">Email</label>
                        <!--%= f.label :Titulo, class: "nifty_form" ,for: "movieTitle" %-->
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="mec9" name="movieTitle" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="mec10" class="col-sm-2 col-form-label">Estado</label>
                        <!--%= f.label :Titulo, class: "nifty_form" ,for: "movieTitle" %-->
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="mec10" name="movieTitle" required>
                        </div>
                    </div>
