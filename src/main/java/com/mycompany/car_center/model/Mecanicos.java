...
public class Mecanicos {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "MecanicosTable")
    private String tipoDocumento;
    @Column(name = "documento", nullable = false, columnDefinition = "int default 100")
    private Integer documento;
    @Column(name = "primer-nombre", nullable = true, length = 150)
    ...
    @Column(name = "estado", nullable = true, length = 150)
    private char estado;
